...
{
    [ApiController]
    [Route("api/mongo/projects")]
    public class ProjectMongoController : ControllerBase
    {
        private readonly IGenericMongoService<ProjectDocument, ProjectDTO> _service;

        public ProjectMongoController(
            IGenericMongoService<ProjectDocument, ProjectDTO> service)
        {
            _service = service;
        }
